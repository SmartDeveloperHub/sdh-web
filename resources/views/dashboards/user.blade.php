...
@section('main-content')
    <div class="row">
        <div class="col-sm-2"> <!-- LEFT PANEL -->
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row"><!-- user -->
                        <div class="col-sm-12">
                            <img src="assets/images/demo/JohnSnow_small.jpg" alt="John Snow" class="img-circle">
        ...
        <div class="col-sm-10">  <!-- CENTER PANEL -->
            ...
            <div class="row">
                <div class="col-sm-4"> <!-- LANGUAGES CHART -->
                    <div class="panel panel-default">
                        <div class="panel-heading">
                ...
                <div class="col-sm-4"> <!-- ISSUES CHART -->
                    <div class="panel panel-default">
                        <div class="panel-heading">
									<span>Issues</span>
                        </div>
